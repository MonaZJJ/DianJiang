    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if (!_this.listEnd && !this.isLoadingData) {
                    ...
                    success: function (data) {
                        ...
                        try {
                            if (data.State == 'SUCCESS') {
                                ...
                                _this.listIndex = parseInt(data.Start) + parseInt(data.List.length);
                                if (_this.listIndex >= data.Total) {
                                    _this.listEnd = true;
                                }
                ...
                //     },
                //     'onerror': function () {
                //         console.log(_this.isLoadingData)
                //         _this.isLoadingData = false;
                //     }
                // });
            }
