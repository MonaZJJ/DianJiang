...
`,
    init: function () {
        ...
        $('body').on('click','.all_output',function(){
            LimitSaleDetail.adminExportTimeProductActivityOrderList();
        })
        //查询按钮点击
    ...
    //导出订单数据
    adminExportTimeProductActivityOrderList:function(){
        var methodName = "/timeproductactivity/AdminExportTimeProductActivityOrderList";
        var data = {
