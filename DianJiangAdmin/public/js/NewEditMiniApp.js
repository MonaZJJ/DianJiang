...
var droplist_menu = `<ul class="droplist-menu">
        ...
        <li data-val="3">
            <a href="javascript:;" data-toggle="modal" data-target="#selectBrand">选择品牌</a>
        </li>
        <li data-val="4">
...
var EditMiniApp = {
    ...
    swiperTpl: `<li class="ui-state-default ui-sortable-handle selected" data-type="1">
        <div class="diy-conitem sweiper">
            <ul>
                <li>
                    <img src="/public/images/mini/1.jpg" alt="">
                </li>
            </ul>
            <ul class="pageList">
        ...
        <li class="ctrl-item-list-li clearfix">
            <div class="fl">
                <div class="imgnav j-selectimg" data-target="#insertcustom_img" data-toggle="modal">
                    <img src="/public/images/mini/1.jpg">
        ...
        <div class="diy-conitem">
            <ul class="clearfix">
                <li class="board7 title_img">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/2.jpg">
                        </a>
                    </span>
                </li>
                <li class="board7 video_img">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/3.jpg">
                        </a>
                    </span>
                </li>
            </ul>
    ...
    app3_modal_tpl: `<ul class="ctrl-item-list">
        ...
        <li class="ctrl-item-list-li clearfix">
            <div class="fl">
                ...
                <span class="fi-help-text txtCenter mgt5 j-verify-pic">722*410</span>
            </div>
    ...
    // endregion
    // app1模板(热销单品，推荐搭配，本周上新)
    app1Tpl: `<li class="ui-state-default ui-sortable-handle selected" data-type="3">
        <div class="diy-conitem">
            <ul class="clearfix appUl">
                <li class="board5 small_img" style="display:block;margin-bottom: 10px">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/4.jpg">
                        </a>
                    </span>
                </li>
                <li class="board5 small_img"style="display:block">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/4.jpg">
                        </a>
                ...
                <li class="board5 big_img" style="position: absolute;right:0;top:0">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/5.jpg">
                        </a>
                    </span>
                </li>
            </ul>
    ...
    //app1模板详情（右边可以选择跳转类型的模板）(热销单品，推荐搭配，本周上新)
    app1_modal_tpl:
    // region
        `<ul class="ctrl-item-list">
         <li class="ctrl-item-list-li clearfix">
    ...
    // endregion
    //app1模板详情（右边可以选择跳转类型的模板）(热销单品，推荐搭配，本周上新) 有数据时
        ...
        <div class="diy-conitem">
            <ul class="clearfix" id="classifyBox">
                <li class="board9 title_img">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/6.jpg">
                        </a>
                    </span>
                </li>
                <li class="board9 big1_img">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/7.jpg">
                        </a>
                    </span>
                </li>
                <li class="board9 big1_img">
                ...
                <li class="board9 small2_img">
                    <span>
                        <a href="#">
                            <img src="/public/images/mini/8.jpg">
                        </a>
                    </span>
                </li>
                <li class="board9 small2_img">
    ...
    replaceToLink: function (str) {
        ...
        //type 1选择商品 2 选择分类 3 选择品牌 4 站外链接 5 站内链接
        if (str.Type == 1) {
            var Str = '<a data-val="' + str.Type + '" href="' + str.link + '" class="typeV badge badge-success"><span class="select_title">选择商品</span><em class="badge-link ovfEps">' + str.showtitle + '</em></a>';
        } else if (str.Type == 2) {
    ...
    selectLink: function (str, selectContent) {
        ...
        if (EditMiniApp.dataVal == 1) {
            var Str = '<a data-Val="1" href="/pages/productCenter/goodDetail/goodDetail?PId=' + EditMiniApp.PId + '" class="typeV badge badge-success" data-ShowImg="' + EditMiniApp.productShowImgFull + '"><span class="select_title">选择商品</span><em class="badge-link ovfEps">' + str + '</em></a>';
        } else if (EditMiniApp.dataVal == 2) {
