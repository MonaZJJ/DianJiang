...
var DepartmentManage = {
    ...
    listInit: function () {
        $('#departmentManage').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/admin/AdminDepartmentList',
            dataType: "json",
            ...
            columns: [{
                ...
                //     valign: 'middle',
                //     formatter: function (value, row, index) {
                //         var e = '<span class="add-time">' + value + '</span>';
                //         return e;
                //     }
                // },
                {
                    ...
                    valign: 'middle',
                    formatter: function (value, row, index) {
                        var e = '<a style="color: #4E70FB;margin-right: 18px" href="/jurisdiction/department_power?departmentId=' + value + '" data-id=' + value + ' class="power_a">部门权限</a>' +
                            '<span style="color: #4E70FB;margin-right: 18px" class="edit_classify_one" data-id=' + value + ' data-toggle="modal" href="#editDepartmentModal">编辑</span>' +
                            '<span style="color: #4E70FB;" class="edit_dele_one" data-id=' + value + '>删除</span>';
    ...
    addDepartment: function () {
        //部门名称
        if (!Validate.emptyValidateAndFocus("#addDepartmentName", "请输入部门名称")) {
            return false;
        }
        //职能说明
        ...
        //请求方法
        var methodName = "/admin/AdminAddDepartment";
        var data = {
    ...
    editDepartment: function (departmentId) {
        ...
        //请求方法
        var methodName = "/admin/AdminUpdateDepartment";
        var data = {
    ...
    deleteDepartment: function (departmentId) {
        //请求方法
        var methodName = "/admin/AdminDeleteDepartment";
        var data = {
            "AdminGId": departmentId
        };
        //请求接口
