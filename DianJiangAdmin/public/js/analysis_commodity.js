var AnalysisCommodity = {
    ...
    init: function () {
        ...
        //商品销售情况
        AnalysisCommodity.start1 = moment().subtract('days', 7).format('YYYY-MM-D');
        AnalysisCommodity.end1 = moment().format('YYYY-MM-D');
    ...
    queryParams: function (params) {
        ...
        var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            StartTime:AnalysisCommodity.start1,
            EndTime:AnalysisCommodity.end1,
