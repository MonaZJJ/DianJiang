var LimitSalePerformanceEdit = {
    ...
    skuTemplateEdit: `
                        ...
                        <div class="panel panel-default" data-id="{{TimeActivityProductInfoList[i].PId}}" data-name="{{TimeActivityProductInfoList[i].Name}}">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a class="skuTitle" data-toggle="collapse" data-parent="#accordion"
                                       href="#collapse{{i}}">
    ...
    init: function () {
        ...
        $('body').on('click', '#editBtn', function () {
            ...
            $('.panel-default').each(function (index, item) {
                ...
                productItemList.Name = $(item).attr('data-name');
    ...
    adminTimeProductActivityInfo: function () {
        ...
        SignRequest.set(methodName, data, function (data) {
            ...
            if (data.Code == "100") {
                ...
                $('#ShareTitle').val(data.Data.TimeProductActivityInfo.Name);
