            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        var html =
                            '<a class="" href="/product/typeEdit_name?id=' + value + '" style="color:#44b8fd;cursor: pointer;"  data-id="' + value + '" >编辑</a>' +
                            '<span style="margin-left:10px;color:#44b8fd;cursor: pointer" class="DelectBtn" data-id="' + value + '">删除</span>';
                        return html;
                    }
                },
