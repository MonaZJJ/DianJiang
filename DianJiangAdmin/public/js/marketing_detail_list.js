...
var MarketingDetailList = {
    init:function(){
        ...
        $('body').on('click','#search_coupon',function(){
            MarketingDetailList.refreshQuery();
        });
        ...
        //点击添加优惠券
        $('body').on("click","#addCoupon",function () {
            $("#coupon_add_modal").modal("show");
        });
        //点击添加设备按钮
        $('body').on('click', '#saveAddData', function () {
            if (!Validate.emptyValidateAndFocus("#coupon_name_add", "请输入发放数量", "")) {
                return false;
            }
            MarketingDetailList.addCouponInfo();
            $('#coupon_add_modal').modal('hide');
            MarketingDetailList.resetData();
        }) ;
    },
    resetData:function(){
        $("#coupon_name_add").val("")
    ...
    initBootstrapTable: function () {
        $("#tb_coupon_list").bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/AdminCoupon/AdminCouponList',
            dataType: "json",
    ...
    refreshQuery: function (parame) {
        //方法名
        var methodName = "/AdminCoupon/AdminCouponList";
