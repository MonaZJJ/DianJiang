var OrderRefundApplication = {
    init: function () {
        ...
        $('body').on('click', '#export', function () {
            OrderRefundApplication.exportAdminRefundList()
        });
        //通过按钮点击
    ...
    //后台导出退款订单列表
    exportAdminRefundList: function () {
        ...
        $('#RefundBox').bootstrapTable({
            ...
            columns: [{
...

                {
                    ...
                    formatter: function (value, row, index) {
                        if (value == "失败") {
                            var html = '<a class="" href="/order/appicationDetail?id=' + row.RefundId + '" style="color:#44b8fd;cursor: pointer;margin-right: 5px"  data-id="' + value + '" >查看详情</a>';
                        } else if (value == "退款中") {
                            var html =
                                ...
                                '<a class="" href="/order/appicationDetail?id=' + row.RefundId + '" style="color:#44b8fd;cursor: pointer"  data-id="' + value + '" >查看详情</a>';
