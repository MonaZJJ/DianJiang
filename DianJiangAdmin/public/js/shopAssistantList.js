...
var MemberList = {
    ...
    init: function () {
        ...
        $("#memberTable").on("click", ".status_delete", function () {
            ...
            Common.confirmDialog("确认删除该店店员吗？", function () {
    ...
    deleteMember: function (UId) {
        var methodName = "/Community/AdminDelCommunityUser";
        var data = {
            CommunityUserId: UId
        };
    ...
    initBootstrapTable: function () {
        $('#memberTable').bootstrapTable({
            method: 'post',
            url: SignRequest.urlPrefix + '/Community/AdminGetCommunityUserList',
            dataType: "json",
    ...
    queryParams: function (params) {
        //配置参数
        //方法名
        var methodName = "/Community/AdminGetCommunityUserList";
    ...
    responseHandler: function (res) {
        if (res.Data != null) {
            console.log(res);
            return {
                "rows": res.Data.AdminCommunityUserPartInfoList,
