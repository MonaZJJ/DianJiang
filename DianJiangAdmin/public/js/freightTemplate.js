var freightTemplate={
    init:function () {
        ...
        $('body').on('click','.addBtnClick',function(){
            location.href = '/product/addFreightTemplate'
        })
    },
    // 获取选中的数据
    ...
    // 删除
    deleteChair:function(mcIdArr){
        var methodName = "/templates/AdminDelTemplates";
        var data = {
            "TemplatesIdList":mcIdArr
        };
                ...
                },
                {
                    ...
                    formatter: function(value, row, index) {
                        ...
                        if(localStorage.getItem('IsStoreManager') == 'true'){
                            html += '<a class="status_edit" href="/platform/editFreightTemplate?id='+value+'" style="margin-right:10px;">编辑</a>';
                        }else{
                            html += '<a class="status_edit" href="/platform/editFreightTemplate?id='+value+'" style="margin-right:10px;">编辑</a>';
