            ...
            columns: [

                {
                    ...
                    formatter: function (value, row, index) {
                        var e = `<span style="display:block;position: relative"><input type="checkbox" data-id="${row.ActivityId}" class="order_checkbox" style="position: absolute;left: 7px;top: 3px;"><span>${value}</span></span>`
                        return e;
                    }
                },
                {
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        var html = `
                                    <a href="/marketMode/limitSalePerformanceEdit?ActivityId=${value}"  class="edit_limit_item">编辑</a>
