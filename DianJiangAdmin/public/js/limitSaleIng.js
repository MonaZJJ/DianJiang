var LimitSaleing = {
    ...
    init: function () {
        ...
        $('body').on('change','.sortinput',function(){
            ...
            LimitSaleing.adminEditTimeProductActivityDisplayOrder(id,val)
        })
        ...
        $('#tb_limit_content').bootstrapTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    valign: 'middle',
                    formatter: function (value, row, index) {
                        var html = `<a href="/marketMode/limitSaleDetail?ActivityId=${value}" class="detail_limit_item">活动详情</a>
                                        <a href='javascript:void(0);' class="end_limit_item" data-id="${value}">提前结束</a>
