...
var MemberGrade = {
    ...
    init: function () {
        ...
        $('body').on('click', '#submitBtn', function () {
            ...
            var creditsLower = $('#creditsLower').val();
            ...
            MemberGrade.adminAddUserRank(name,creditsLower,memberPrice,note)
        });
        //删除按钮点击
    ...
    //后台添加会员等级信息
    adminAddUserRank: function (name,creditsLower,memberPrice,note) {
        //请求方法
        ...
        $('#memberGradeBox').bootstrapTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        if (value == "0") {
                            var e = '<img alt="" src="/public/images/wrong.png">';
                        } else if (value == "1") {
                            var e = '<img alt="" src="/public/images/allright.png">';
                        }
